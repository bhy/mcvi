/**
   There are 4 doors on a continuous corridor. The robot needs to get
   to the third door from the left and open it.  The robot does not
   know its exact location, but can gather information from 4
   observations: Left-End, Right-End, Door,and Corridor
